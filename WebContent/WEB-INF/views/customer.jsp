...
<title>Support Team -Server Monitor</title>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li class=""><a href="cusrequest">Customer Request</a></li>
			...
			<div id="collapse1" class="panel-collapse collapse in">
				<div class="panel-body">
					<div class="x_content" class="collapse" id="View">
						<div class="row">
							<br>
							<table id="tblCustomertData" class="table table-striped table-bordered"
		...
		function load() {
			$.ajax({
				...
				success : function(data, textStatus, jqXHR) {
					...
					console.log(jqXHR);
					$('#tblCustomertData').DataTable({
						"columns" : [ 
							{	"data" : "customerId",
								render : function(data, type, row) {
									return "<a href='cusrequest?customerId=" + data + "'>" + data + "&nbsp;<span class='glyphicon glyphicon-link' style='color:#0000ff;'></span></a>";
								}	
							},
							{	"data" : "firstName"}, 
							{   "data" : "lastName" }, 
							...
							{	"data" : "address"},
							{
								...
								render : function(data, type, row) {
									if(data=="Active")
										return "<span class='glyphicon glyphicon-ok-sign' style='color:#00ff00;'></span>&nbsp;" + data;
									return "<span class='glyphicon glyphicon-ok-sign' style='color:#ff0000;'></span>&nbsp;" + data;
								}
							}],
						"data" : data
